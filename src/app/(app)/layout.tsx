  ...
  return (
    <div className="flex min-h-screen flex-col md:flex-row">
      ...
      >
        ...
        <div className="workspace-content mx-auto max-w-[1440px] px-5 py-7 md:px-8 lg:px-10 lg:py-8">
          {children}
        </div>
        <footer className="mx-5 flex flex-wrap justify-between gap-2 border-t py-6 text-[11px] text-muted-foreground md:mx-8 lg:mx-10">
